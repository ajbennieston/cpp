...
We might expect this to work; that is, our derived class should have the overloaded functions \texttt{void func(int x)} and \texttt{void func(std::string x)}. The compiler, however, has other ideas, and will typically warn you that ``\texttt{Derived::func(std::string)} hides \texttt{Base::func(int)}''.
