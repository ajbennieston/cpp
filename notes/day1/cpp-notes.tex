...
In reality, there are no ``boolean literals''. There are, however, two C++ keywords (words reserved for use by the language, which must not be used as variable names, etc.) \texttt{true} and \texttt{false}.
